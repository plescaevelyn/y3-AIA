...
namespace SubiectRomDB
{
    class Program
    {
        static string ds = @"Data Source=SAM-TOSH\SQLEXPRESS";
        ...
        {
            SqlConnection con2 = new SqlConnection(@"Data Source=SAM-TOSH\SQLEXPRESS;Initial Catalog=Romania; Integrated Security = True");
